    ...
    <section className="bg-[#F4F4F4] py-32">
      ...
      <div className="w-full px-6 xl:px-10">
        <div className="mx-auto max-w-[1600px]">
          ...
          <div className="mb-20">
            {/* TITLE */}
            <h2 className="mb-6 text-2xl md:text-5xl lg:text-6xl font-[600] leading-[0.85] tracking-tight text-black whitespace-nowrap">
              Event Insights & Industry Trends
            </h2>

            {/* SUBTEXT + BUTTON */}
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <p className="max-w-[900px] text-lg md:text-xl leading-relaxed text-gray-700">
          ...
          <div className="grid gap-12 xl:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                <h4 className="mb-4 text-3xl font-bold leading-tight transition-colors hover:text-[#0092D7]">
                  {articles[0].title}
                </h4>
              </a>
            ...
            <div className="flex flex-col gap-8">
              {articles.slice(1).map((article, index) => (
                <div
                  key={index}
                  className="grid gap-8 rounded-2xl bg-white p-6 lg:grid-cols-2"
                >
                  <img
                    src={article.image}
                    alt={article.title}
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <a
                      ...
                      className="text-black"
                    >
                      <h4 className="text-xl font-bold leading-tight transition-colors hover:text-[#0092D7]">
                        {article.title}
                      </h4>
                    </a>
