        ...
        <div className="mx-auto max-w-[1600px]">
          <div className="grid lg:grid-cols-12 gap-16">
            <div className="lg:col-span-7 lg:border-l lg:border-white/20 lg:pl-14">
              <h2 className="text-6xl md:text-7xl lg:text-7xl font-bold leading-[0.85] tracking-tight">
              ...
              <a href="/post-show-report" className="inline-block mt-10">
                <button className="rounded-full bg-white text-[#0092D7] px-10 py-4 font-semibold hover:bg-[#0092D7] hover:text-white transition">
