    ...
    return (
      <div className="p-6 min-h-[400px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 font-medium">Loading housekeeping configuration...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">Manage housekeeping staff rates and shifts</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
          <p className="text-sm text-gray-600">Rate per Shift</p>
          <p className="text-2xl font-bold text-blue-600">{formatCurrency(config?.chargesPerShift || 0)}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
          <p className="text-sm text-gray-600">Daily Cost (2 staff)</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Housekeeping Rate</h2>
            <p className="text-sm text-gray-500">Charges per shift ({config?.shiftHours || 10} hours)</p>
          </div>
        </div>
        ...
        {!editing ? (
          <div className="space-y-6">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <span className="text-4xl font-bold text-blue-600">{formatCurrency(config?.chargesPerShift || 0)}</span>
                <span className="text-sm text-gray-500 ml-2">per shift</span>
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs text-gray-500 mt-2">Default rate: ₹2,000 per shift</p>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  min="1"
                />
                <span className="text-sm text-gray-500 self-center">staff</span>
                <button
            ...
            <div className="space-y-3">
              {history.map((item, index) => (
                <div key={index} className="flex justify-between items-center py-2 border-b last:border-0 hover:bg-gray-50 px-2 rounded">
                  <div>
                    <span className="font-medium text-blue-600">{formatCurrency(item.chargesPerShift)}</span>
                    <span className="text-xs text-gray-500 ml-2">({item.shiftHours} hrs shift)</span>
                  </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-600">{stats.shiftHours} hrs</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-600 mb-1">Hourly Rate</p>
              <p className="text-lg font-bold text-green-600">{formatCurrency(stats.hourlyRate)}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
      ...
      <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
        <h3 className="text-sm font-semibold text-blue-800 mb-2">Quick Reference</h3>
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            <p className="text-xs text-blue-600 mb-1">1 Shift</p>
            <p className="text-lg font-bold text-blue-600">{formatCurrency(config?.chargesPerShift || 0)}</p>
          </div>
          <div className="text-center">
            <p className="text-xs text-blue-600 mb-1">2 Shifts</p>
            <p className="text-lg font-bold text-blue-600">{formatCurrency((config?.chargesPerShift || 0) * 2)}</p>
          </div>
          <div className="text-center">
            <p className="text-xs text-blue-600 mb-1">3 Shifts</p>
            <p className="text-lg font-bold text-blue-600">{formatCurrency((config?.chargesPerShift || 0) * 3)}</p>
          </div>
        </div>
