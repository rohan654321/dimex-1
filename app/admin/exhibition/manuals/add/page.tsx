...
export default function RequirementsPage() {
  ...
  const fetchProfileData = async () => {
    try {
      ...
      // Extract name parts
      const fullName = exhibitorData.name || exhibitorData.contactPerson || '';
      const nameParts = fullName.split(' ');
      const firstName = nameParts[0] || '';
      const lastName = nameParts.slice(1).join(' ') || '';

      // Auto-fill General Info
      setGeneralInfo(prev => ({
        ...prev,
        firstName: firstName,
        lastName: lastName,
        mobile: exhibitorData.phone || '',
        email: exhibitorData.email || '',
        companyName: exhibitorData.company || exhibitorData.companyName || '',
        businessNature: exhibitorData.sector || exhibitorData.industry || '',
      ...
      setLocationDetails(prev => ({
        ...prev,
        boothNo: stallData.boothNumber || stallData.standNumber || exhibitorData.boothNumber || '',
        boothType: (stallDetails.type || stallData.boothType || exhibitorData.boothType || 'Shell Scheme') as any,
      }));

      // Auto-fill Booth Details
      setBoothDetails(prev => ({
        ...prev,
        boothNo: stallData.boothNumber || stallData.standNumber || exhibitorData.boothNumber || '',
        exhibitorName: exhibitorData.company || exhibitorData.companyName || '',
        sqMtrBooked: stallDetails.size || stallData.boothSize || exhibitorData.boothSize || '',
        organisation: exhibitorData.company || exhibitorData.companyName || '',
      ...
      setCompanyDetails(prev => ({
        ...
        telephone: exhibitorData.phone || '',
        mobile: exhibitorData.mobile || exhibitorData.phone || '',
        email: exhibitorData.email || '',
        website: exhibitorData.website || '',
        contactPerson: exhibitorData.name || exhibitorData.contactPerson || '',
        designation: exhibitorData.designation || '',
        productsServices: exhibitorData.description || ''
      }));
      ...
      setProfileData({
        ...
        boothNumber: stallData.boothNumber || stallData.standNumber || exhibitorData.boothNumber,
        boothSize: stallDetails.size || stallData.boothSize || exhibitorData.boothSize,
        boothType: stallDetails.type || stallData.boothType || exhibitorData.boothType,
        boothDimensions: stallDetails.dimensions || stallData.boothDimensions || exhibitorData.boothDimensions,
        boothNotes: stallDetails.notes || stallData.boothNotes || exhibitorData.boothNotes,
        registrationDate: exhibitorData.createdAt || exhibitorData.registrationDate
      });
